#  Aprendendo sobre Ferramentas de desenvolvimento Web

> Ferramentas de desenvolvimento Web (conhecidas como _browser dev tools_) permitem o desenvolvedor testar e debugar seu código. Elas são diferentes de geradores de sites e IDE's, elas não ajudam na criação direta de uma página web, elas são ferramentas para testar como um usuário verá e irá interagir com a interface de um website ou uma aplicação web.
...
Eu sugiro aprender e usar as referencias do [Chrome developer tools (Ferramentas de desenvolvedores Chrome)](https://developers.google.com/web/tools/chrome-devtools/), simplesmente porque é o melhor recurso para aprender sobre as ferramentas para desenvolvedores do chrome.
