...
* Universal JavaScript solutions will continue to rise that pay homage/respect to the days of [server delivered front-ends (html to the client)](https://github.com/zeit/next.js).
